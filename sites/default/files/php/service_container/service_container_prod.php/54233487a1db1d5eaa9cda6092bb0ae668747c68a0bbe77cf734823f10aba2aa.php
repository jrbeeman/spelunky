...
class service_container_prod extends \Drupal\Core\DependencyInjection\Container
{
    ...
    {
        return $this->services['container.namespaces'] = new \ArrayObject(array('Drupal\\block' => '/Users/jbeeman/Sites/spelunky/core/modules/block/lib', 'Drupal\\breakpoint' => '/Users/jbeeman/Sites/spelunky/core/modules/breakpoint/lib', 'Drupal\\ckeditor' => '/Users/jbeeman/Sites/spelunky/core/modules/ckeditor/lib', 'Drupal\\config' => '/Users/jbeeman/Sites/spelunky/core/modules/config/lib', 'Drupal\\contextual' => '/Users/jbeeman/Sites/spelunky/core/modules/contextual/lib', 'Drupal\\datetime' => '/Users/jbeeman/Sites/spelunky/core/modules/datetime/lib', 'Drupal\\dblog' => '/Users/jbeeman/Sites/spelunky/core/modules/dblog/lib', 'Drupal\\editor' => '/Users/jbeeman/Sites/spelunky/core/modules/editor/lib', 'Drupal\\entity' => '/Users/jbeeman/Sites/spelunky/core/modules/entity/lib', 'Drupal\\entity_reference' => '/Users/jbeeman/Sites/spelunky/core/modules/entity_reference/lib', 'Drupal\\field' => '/Users/jbeeman/Sites/spelunky/core/modules/field/lib', 'Drupal\\field_ui' => '/Users/jbeeman/Sites/spelunky/core/modules/field_ui/lib', 'Drupal\\file' => '/Users/jbeeman/Sites/spelunky/core/modules/file/lib', 'Drupal\\filter' => '/Users/jbeeman/Sites/spelunky/core/modules/filter/lib', 'Drupal\\help' => '/Users/jbeeman/Sites/spelunky/core/modules/help/lib', 'Drupal\\image' => '/Users/jbeeman/Sites/spelunky/core/modules/image/lib', 'Drupal\\link' => '/Users/jbeeman/Sites/spelunky/core/modules/link/lib', 'Drupal\\menu' => '/Users/jbeeman/Sites/spelunky/core/modules/menu/lib', 'Drupal\\menu_link' => '/Users/jbeeman/Sites/spelunky/core/modules/menu_link/lib', 'Drupal\\node' => '/Users/jbeeman/Sites/spelunky/core/modules/node/lib', 'Drupal\\options' => '/Users/jbeeman/Sites/spelunky/core/modules/options/lib', 'Drupal\\shortcut' => '/Users/jbeeman/Sites/spelunky/core/modules/shortcut/lib', 'Drupal\\system' => '/Users/jbeeman/Sites/spelunky/core/modules/system/lib', 'Drupal\\taxonomy' => '/Users/jbeeman/Sites/spelunky/core/modules/taxonomy/lib', 'Drupal\\text' => '/Users/jbeeman/Sites/spelunky/core/modules/text/lib', 'Drupal\\toolbar' => '/Users/jbeeman/Sites/spelunky/core/modules/toolbar/lib', 'Drupal\\update' => '/Users/jbeeman/Sites/spelunky/core/modules/update/lib', 'Drupal\\user' => '/Users/jbeeman/Sites/spelunky/core/modules/user/lib', 'Drupal\\views_ui' => '/Users/jbeeman/Sites/spelunky/core/modules/views_ui/lib', 'Drupal\\views' => '/Users/jbeeman/Sites/spelunky/core/modules/views/lib', 'Drupal\\spelunky' => '/Users/jbeeman/Sites/spelunky/profiles/spelunky/lib', 'Drupal\\Core\\Entity' => '/Users/jbeeman/Sites/spelunky/core/lib', 'Drupal\\Core\\Field' => '/Users/jbeeman/Sites/spelunky/core/lib', 'Drupal\\Core\\Http' => '/Users/jbeeman/Sites/spelunky/core/lib', 'Drupal\\Core\\Mail' => '/Users/jbeeman/Sites/spelunky/core/lib', 'Drupal\\Core\\TypedData' => '/Users/jbeeman/Sites/spelunky/core/lib', 'Drupal\\Core\\Validation' => '/Users/jbeeman/Sites/spelunky/core/lib', 'Drupal\\Component\\Annotation' => '/Users/jbeeman/Sites/spelunky/core/lib'));
    }
    ...
    {
        return $this->services['field.info'] = new \Drupal\field\FieldInfo($this->get('cache.field'), $this->get('config.factory'), $this->get('module_handler'), $this->get('plugin.manager.field.field_type'), $this->get('language_manager'));
    }
    ...
    {
        return $this->services['plugin.manager.views.area'] = new \Drupal\views\Plugin\ViewsHandlerManager('area', $this->get('container.namespaces'), $this->get('views.views_data'), $this->get('cache.views_info'), $this->get('language_manager'), $this->get('module_handler'));
    }
    ...
    {
        return $this->services['plugin.manager.views.argument'] = new \Drupal\views\Plugin\ViewsHandlerManager('argument', $this->get('container.namespaces'), $this->get('views.views_data'), $this->get('cache.views_info'), $this->get('language_manager'), $this->get('module_handler'));
    }
    ...
    {
        return $this->services['plugin.manager.views.field'] = new \Drupal\views\Plugin\ViewsHandlerManager('field', $this->get('container.namespaces'), $this->get('views.views_data'), $this->get('cache.views_info'), $this->get('language_manager'), $this->get('module_handler'));
    }
    ...
    {
        return $this->services['plugin.manager.views.filter'] = new \Drupal\views\Plugin\ViewsHandlerManager('filter', $this->get('container.namespaces'), $this->get('views.views_data'), $this->get('cache.views_info'), $this->get('language_manager'), $this->get('module_handler'));
    }
    ...
    {
        return $this->services['plugin.manager.views.join'] = new \Drupal\views\Plugin\ViewsHandlerManager('join', $this->get('container.namespaces'), $this->get('views.views_data'), $this->get('cache.views_info'), $this->get('language_manager'), $this->get('module_handler'));
    }
    ...
    {
        return $this->services['plugin.manager.views.relationship'] = new \Drupal\views\Plugin\ViewsHandlerManager('relationship', $this->get('container.namespaces'), $this->get('views.views_data'), $this->get('cache.views_info'), $this->get('language_manager'), $this->get('module_handler'));
    }
    ...
    {
        return $this->services['plugin.manager.views.sort'] = new \Drupal\views\Plugin\ViewsHandlerManager('sort', $this->get('container.namespaces'), $this->get('views.views_data'), $this->get('cache.views_info'), $this->get('language_manager'), $this->get('module_handler'));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Drupal\Core\Template\TwigEnvironment($this->get('twig.loader.filesystem'), array('cache' => true, 'autoescape' => false, 'strict_variables' => false, 'debug' => false, 'auto_reload' => NULL), $this->get('module_handler'), $this->get('theme_handler'));
    ...
    {
        return $this->services['twig.loader.filesystem'] = new \Twig_Loader_Filesystem('/Users/jbeeman/Sites/spelunky');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'container.modules' => array(
                ...
                'spelunky' => array(
                    'type' => 'profile',
                    'pathname' => 'profiles/spelunky/spelunky.info.yml',
                    'filename' => 'spelunky.profile',
                ),
            ),
            'container.namespaces' => array(
                'Drupal\\block' => '/Users/jbeeman/Sites/spelunky/core/modules/block/lib',
                'Drupal\\breakpoint' => '/Users/jbeeman/Sites/spelunky/core/modules/breakpoint/lib',
                'Drupal\\ckeditor' => '/Users/jbeeman/Sites/spelunky/core/modules/ckeditor/lib',
                'Drupal\\config' => '/Users/jbeeman/Sites/spelunky/core/modules/config/lib',
                'Drupal\\contextual' => '/Users/jbeeman/Sites/spelunky/core/modules/contextual/lib',
                'Drupal\\datetime' => '/Users/jbeeman/Sites/spelunky/core/modules/datetime/lib',
                'Drupal\\dblog' => '/Users/jbeeman/Sites/spelunky/core/modules/dblog/lib',
                'Drupal\\editor' => '/Users/jbeeman/Sites/spelunky/core/modules/editor/lib',
                'Drupal\\entity' => '/Users/jbeeman/Sites/spelunky/core/modules/entity/lib',
                'Drupal\\entity_reference' => '/Users/jbeeman/Sites/spelunky/core/modules/entity_reference/lib',
                'Drupal\\field' => '/Users/jbeeman/Sites/spelunky/core/modules/field/lib',
                'Drupal\\field_ui' => '/Users/jbeeman/Sites/spelunky/core/modules/field_ui/lib',
                'Drupal\\file' => '/Users/jbeeman/Sites/spelunky/core/modules/file/lib',
                'Drupal\\filter' => '/Users/jbeeman/Sites/spelunky/core/modules/filter/lib',
                'Drupal\\help' => '/Users/jbeeman/Sites/spelunky/core/modules/help/lib',
                'Drupal\\image' => '/Users/jbeeman/Sites/spelunky/core/modules/image/lib',
                'Drupal\\link' => '/Users/jbeeman/Sites/spelunky/core/modules/link/lib',
                'Drupal\\menu' => '/Users/jbeeman/Sites/spelunky/core/modules/menu/lib',
                'Drupal\\menu_link' => '/Users/jbeeman/Sites/spelunky/core/modules/menu_link/lib',
                'Drupal\\node' => '/Users/jbeeman/Sites/spelunky/core/modules/node/lib',
                'Drupal\\options' => '/Users/jbeeman/Sites/spelunky/core/modules/options/lib',
                'Drupal\\shortcut' => '/Users/jbeeman/Sites/spelunky/core/modules/shortcut/lib',
                'Drupal\\system' => '/Users/jbeeman/Sites/spelunky/core/modules/system/lib',
                'Drupal\\taxonomy' => '/Users/jbeeman/Sites/spelunky/core/modules/taxonomy/lib',
                'Drupal\\text' => '/Users/jbeeman/Sites/spelunky/core/modules/text/lib',
                'Drupal\\toolbar' => '/Users/jbeeman/Sites/spelunky/core/modules/toolbar/lib',
                'Drupal\\update' => '/Users/jbeeman/Sites/spelunky/core/modules/update/lib',
                'Drupal\\user' => '/Users/jbeeman/Sites/spelunky/core/modules/user/lib',
                'Drupal\\views_ui' => '/Users/jbeeman/Sites/spelunky/core/modules/views_ui/lib',
                'Drupal\\views' => '/Users/jbeeman/Sites/spelunky/core/modules/views/lib',
                'Drupal\\spelunky' => '/Users/jbeeman/Sites/spelunky/profiles/spelunky/lib',
                'Drupal\\Core\\Entity' => '/Users/jbeeman/Sites/spelunky/core/lib',
                'Drupal\\Core\\Field' => '/Users/jbeeman/Sites/spelunky/core/lib',
                'Drupal\\Core\\Http' => '/Users/jbeeman/Sites/spelunky/core/lib',
                'Drupal\\Core\\Mail' => '/Users/jbeeman/Sites/spelunky/core/lib',
                'Drupal\\Core\\TypedData' => '/Users/jbeeman/Sites/spelunky/core/lib',
